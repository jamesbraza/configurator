...
`pre-commit` hook [mirror](https://github.com/pre-commit/mirrors-prettier)
...
TODO: yamllint, codespell, hadolint
...
Brand new as of Feb 15th in 2024
(last week, when this `README.md` made).
